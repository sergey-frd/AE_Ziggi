...
function main() 
{
   ...
   // AAAAAAAAAAAAAAAAAAAAAAAAAAAA
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Ziggi\\xml\\gen_System_22_3.xml");
    ...
    var compFinalName = "aeFinalZig_22_3t_pari_1";
    finalComp = handleFinalCompAll(compFinalName);

    var compFinalName = "aeFinalZig_22_3t_pari_1_bg_1";
    finalComp = handleFinalCompAll_Bg(compFinalName);

    var compFinalName = "aeFinalZig_22_3t_pari_bg_2";
